...
const calculate = () => {
  if (건강보험료.value < 10000 || isNaN(+건강보험료.value)) {
    toast.add({
            ...
            <template v-for="i in 7">
              <template v-if="i <= selectedPeople">
                <UIcon
                  ...
                  @click="
                    selectedPeople = selectedPeople === i && i > 1 ? i - 1 : i
                  "
                />
              </template>
              <template v-else>
      ...
      <div>
        <template v-if="보수월액 > 0">
          <div class="text-xl leading-7 flex gap-3">
            ...
            <div>{{ 건강보험료.toLocaleString() }}원</div>
          </div>
        </template>
        <template v-else>
          <div class="text-xl font-bold leading-7">건강보험료?</div>
      ...
      <template v-if="보수월액 > 0">
        ...
        <div>
          <div class="flex items-center gap-3">
            <div class="text-xl font-bold leading-7 flex-1" ref="스크롤지점">
              건강보험료로 추정된 월 소득
            </div>
            <UPopover>
              <UButton
          ...
          <div class="text-xs text-gray-400">비과세 소득 제외된 월 소득</div>
                ...
                <template #panel>
                  <div class="p-3">
                    <div class="text-black text-sm">
                      각종 <b class="text-primary">복지제도</b>에 활용되는
                      소득기준
                    </div>
                    <UDivider class="py-1" />
                    <div class="text-xs text-gray-400">
            ...
            <div class="flex-1 flex gap-1 items-center">
              ...
              <UPopover>
                ...
                <template #panel>
                  <div class="p-3">
                    <div class="text-black text-sm">
                      각종 <b class="text-primary">청약/임대 제도</b>에 활용되는
                      소득기준
                    </div>
                    <UDivider class="py-1" />
                    <div class="text-xs text-gray-400">
